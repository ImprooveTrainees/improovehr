...
class HarvestController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $headers = array();
        $headers[] = 'Harvest-Account-Id:'.$harvestAccId;
        $headers[] = 'Authorization: Bearer '.$harvestToken;
...
return view('testeHarvest')
    ...
    else if($userExistFlextime != null) { //caso exista há o user na DB
        $workHoursSettings = settings_general::orderBy('created_at', 'desc')->first();
...
return view('testeHarvest')
    ...
    //caso só queira mostrar a form, sem nada na db e sem nada inserido
    else {
        return view('testeHarvest');
