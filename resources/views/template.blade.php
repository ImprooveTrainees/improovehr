    ...
    <div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-left">
                    <div class="navbar-btn">
                        <a href="index.html"><img src="../assets/images/icon.svg" alt="Improove Logo"
                ...
                <div class="navbar-right">
                    <div id="navbar-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="../login/logout.php" class="icon-menu"><i class="icon-power"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div id="left-sidebar" class="sidebar">
            <div class="navbar-brand">
                <a href="index.html"><img src="../assets/images/icon.svg" alt="Oculux Logo"
                        class="img-fluid logo"><span>Improove HR</span></a>
            ...
            <div class="sidebar-scroll">
                <div class="user-account">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right account vivify flipInY">
                            ...
                            <li><a href="javascript:void(0);"><i class="icon-settings"></i>Definições</a></li>
                            <li class="divider"></li>
                            <li><a href="../login/logout.php"><i class="icon-power"></i>Logout</a></li>
                        </ul>
                    </div>
                </div>
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu">
                        ...
                        <li class="active"><a href="profile.php"><i class="icon-home"></i><span>Home</span></a></li>
                        <li>
                            <a href="#myPage" class="has-arrow"><i class="icon-user"></i><span>Página Pessoal</span></a>
                            <ul>
                                <li><a href="page-profile.html">Dashboard/Perfil</a></li>
                                <li><a href="index4.php">Férias/Ausências</a></li>
                                <li><a href="index4.php">Flex-Time</a></li>
                                <li><a href="index4.php">Avaliações</a></li>
                            </ul>
                        </li>
                        <li><a href="index4.php"><i class="icon-users"></i><span>Colaboradores</span></a></li>
...
<script src="../html/assets/bundles/knob.bundle.js"></script><!-- Jquery Knob-->
<script src="../html/assets/bundles/c3.bundle.js"></script>
<script src="../html/assets/bundles/flotscripts.bundle.js"></script><!-- flot charts Plugin Js --> 
<script src="../html/assets/bundles/jvectormap.bundle.js"></script><!-- JVectorMap Plugin Js -->

<script src="../html/assets/bundles/mainscripts.bundle.js"></script>
<script src="../html/assets/js/index4.js"></script>
</body>
</html>